export default function SocialMediaLinks() {
    return (
        <div className="flex justify-center space-x-2 text-gray-300">
            <a href="https://www.linkedin.com/in/alexanderschreiner/" target='_blank' rel='noreferrer'>
            ...
            <a href="https://github.com/alexander-schreiner/" target='_blank' rel='noreferrer'>
